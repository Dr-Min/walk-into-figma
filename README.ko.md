...
연기는 사용자가 사유, 담당자, 목표 릴리스 또는 재검토일, 현재 릴리스 영향, 임시 동작을 승인한 경우에만 유효합니다. 현재 릴리스의 합법성, 안전, 개인정보, 결제 무결성, 핵심 여정 또는 인수 테스트에 필요한 결정은 연기할 수 없습니다.
...
- **웹 조사**: 최신 법률, 가격, 공급업체 기능 등 변동되는 사실
...
- 토큰, 쿠키, 비공개 Figma 키, 개인 이메일, 고객 데이터, 운영 인증정보를 커밋하지 마세요.
- 프로젝트별 민감 자료는 이 공개 저장소 밖에 보관하세요.
- 생성된 결과물을 공유하기 전에 검수하세요.
- 법률, 정책, 가격, 공급업체 기능은 변동 정보로 취급하고 공식 출처를 확인하세요.
